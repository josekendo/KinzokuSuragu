...
void Juego::cargarNivel(int niv)
{
    ...
    nivel->crearEnemigo(50,10,1,3,1,1,15000,254);
    }
    else if(niv==2){
    ...
    nivel->crearEnemigo(500,0,4,2,2,4,4300,322);
    ...
    nivel->crearEnemigo(1000,50,5,5,2,5,11100,322);
    nivel->crearEnemigo(100,0,3,4,2,3,15000,282);
    }
}
